...
<main id="main" class="main ">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" >
                <label class="form-check-label">I need more features (please indicate which features in comments)</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" >
                <label class="form-check-label">I found better booking system (please indicate in comments the name of the system and the features you liked about them)</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" >
                <label class="form-check-label">I will register another company with you, just need to close this one.</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" >
                <label class="form-check-label">The system is too complex and not intuitive enough (please explain in comments if possible)</label>
            </div>
...
2. By deleting an account, I agree that my data will be permanently deleted, and that I have saved all the data I need
            ...
            <div class="row mt-3">
                <div class="col-4"><button class="btn btn-danger">Delete my account now</button></div>
                <div class="col-4"><button class="btn btn-primary">cancel account deleting</button></div>
            </div>
