...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="header-nav" style="display: inline-block; width: 100%">
        <ul class="d-flex">
...
<!--            </li>-->
            ...
            <li class="nav-item dropdown pe-3 " style="margin-left: auto !important;">
...
<!--                    </li>-->
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" onclick="localStorage.setItem('token', ''); window.location.reload()">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-house"></i><span>Manage</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-receipt"></i><span>Report</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
